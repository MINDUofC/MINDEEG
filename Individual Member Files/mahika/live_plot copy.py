...
def main():
    ...
    commands = [
    "chon_1_12",  # Enable channel 1 with gain 12 (turn on channel 1)
    "rldadd_1",   # Toggle right leg drive for channel 1 (turn on right leg drive (reference= common electrode))
